...
class NotifyTransactionsTest extends TestCase
{
    use RefreshDatabase, WithFaker;

    public function testNotificationIsSentOnTransaction()
    {
        Http::fake([
        ...
        $payee = User::factory()->create(['balance' => 500, 'is_merchant' => true]);
        ...
        Http::assertSent(function ($request) {
            return $request->url() == 'https://run.mocky.io/v3/54dc2cf1-3add-45b5-b5a9-6bf7e7f1f4a6';
        });
    }
    ...
    public function testUserCanSendMoneyWithSufficientBalance()
    {
        ...
        Http::fake([
            'https://run.mocky.io/v3/5794d450-d2e2-4412-8131-73d0293ac1cc' => Http::response(['message' => 'Autorizado'], 200),
            'https://run.mocky.io/v3/54dc2cf1-3add-45b5-b5a9-6bf7e7f1f4a6' => Http::response(['status' => 'Success'], 200),
            '*' => Http::response([], 404)
        ]);
